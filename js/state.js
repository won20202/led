...
export const DEFAULT_FAQ = [
  ...
  { q: 'LED가 안 켜져요', k: 'LED 안켜짐 점등 불량 고장', a: '순서대로 확인해 보세요. ① 긴 다리(+)가 (+)줄에 붙어 있나요? ② 두 다리가 서로 다른 줄에 붙어 있나요? ③ 테이프가 중간에 끊기지 않았나요? ④ (+)줄과 (−)줄이 서로 닿지 않았나요? ⑤ 홀더 스위치가 켜져 있나요?', tab: 'circuit' },
  { q: 'LED를 직렬로 연결하면 안 되나요?', k: '직렬 병렬 연결 방법', a: '백색 LED는 1개 켜는 데 약 3V가 필요합니다. 우리 전원은 AA 2개 = 3V입니다. 직렬로 2개를 이으면 몇 V가 필요할지 계산해 보세요. 회로 탭에서 직접 실험해 볼 수 있습니다.', tab: 'circuit' },
...
export const DEFAULT_CONFIG = {
  ...
  ledCount: 8, voltage: 3.0, vf: 3.0, imax: 200,
...
export function blankWork() {
  return {
    ...
    circuit: { leds: [], tapes: [], holder: null, predictCount: '', tested: false },
    design: {
      letters: [
        { text: '', x: 5.5, y: 5, size: 6, stroke: 0.9 },
        { text: '', x: 13.5, y: 5, size: 6, stroke: 0.9 },
      ],
      picto: { shape: 'none', x: 20, y: 5, size: 4.5 },
    },
    order: [],
    log: [],
    updatedAt: 0,
